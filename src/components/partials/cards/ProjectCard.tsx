    ...
    return (
        <li className={"grid lg:grid-cols-2 p-1 group overflow-hidden rounded-xl bg-gradient-to-bl " + props.bgFrom + " " + props.bgTo}>
            ...
            <div className="relative group">
                ...
                <ul className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 p-16 rounded min-w-max invisible group-hover:visible delay-300 ease-in-out">
                    <li className="inline-block bg-gradient-to-bl from-gray-600 to-gray-800/50 hover:to-gray-900 border border-transparent hover:border-gray-700 hover:delay-300 ease-linear rounded-full mr-4">
                        <a href="#"
                    ...
                    <li className="inline-block bg-gradient-to-bl from-gray-600 to-gray-800/50 hover:to-gray-900 border border-transparent hover:border-gray-700 hover:delay-300 ease-linear rounded-full">
                        <a href="#"
                           className="flex flex-row justify-evenly items-center gap-2 px-3.5 py-2">
                            <span>Code</span>
