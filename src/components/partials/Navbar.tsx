export default function Navbar() {
  return (
    <>
      <nav className="flex flex-row justify-evenly items-center shadow backdrop-blur-lg dark:bg-opacity-50 leading-8 py-3 sticky top-0 left-0 right-0 dark:bg-black/20 z-50">
