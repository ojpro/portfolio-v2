                ...
                <div
                    ...
                    <div className="max-w-2xl flex flex-col justify-between gap-4">
                        ...
                        <div className="flex flex-row flex-nowrap gap-4 justify-start mt-4">
                            <a href="#contact" className="py-2.5 px-4 bg-[#4462f5] text-white rounded-full">Let&apos;s work</a>
                            <a href="#" className="py-2.5 px-4 border border-[#4462f5] text-[#4462f5] rounded-full">Want My
                                Resume ?</a>
                        </div>
                    </div>
                    <div className="relative bg-gray-800 backdrop-blur-md dark:bg-opacity-60 hover:dark:bg-opacity-80 rounded-xl p-1 hover:rotate-2 shadow-2xl m-10">
                        <Image src={MyPicture}
