            ...
            <section className="container mx-auto px-8">
                ...
                <div className="w-11/12 mx-auto">
                    <ul className="flex flex-col justify-between gap-16">
                        <ProjectCard title="SteakHouse" description="SteakHouse - Discovery and get the best steak." image={steakhouse}
                        ...
                        <ProjectCard title="Executive" description="Executive - We Help to Build Your Dream" image={executive}
                        ...
                        <ProjectCard title="Coliving" description="Coliving - Book affordable and hassle-free coliving spaces, all amenities included." image={coliving}
